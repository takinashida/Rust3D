...
mod tests {
    ...
    fn out_of_bounds_reads_air() {
        let chunk = Chunk::new();
        assert_eq!(chunk.get_i32(-1, 0, 0), Block::Air);
        assert_eq!(chunk.get_i32(CHUNK_SIZE as i32, 0, 0), Block::Air);
    }

    #[test]
    fn set_writes_inside_bounds() {
        let mut chunk = Chunk::new();
        chunk.set(1, 1, 1, Block::Dirt);
        assert_eq!(chunk.get_i32(1, 1, 1), Block::Dirt);
    }
}
